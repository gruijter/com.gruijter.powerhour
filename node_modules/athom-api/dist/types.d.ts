...
declare module AthomCallbackAPI {
    /**
     *
...
declare module AthomConnectAPI {
    /**
     *
...
declare module AthomFirmwareAPI {
    /**
     *
...
declare module AthomSignalsAPI {
    /**
     *
...
declare module AthomWebhooksAPI {
    /**
     *
...
declare module HomeyAPI {
    ...
    module ManagerDevices {
        ...
        module Device {
             ...
             * A CapabilityInstance can be used to integrate a two-way sync of capability states into your app.
             *
             * @see HomeyAPI.ManagerDevices.Device#makeCapabilityInstance
             *
             * @memberof HomeyAPI.ManagerDevices.Device
             * @hideconstructor
             */
...
declare class AthomAppsAPI {
     ...
     * @protected
     */
    protected syncApps(opts?: any): any[];
    /**
     *
     * @param {object} [opts] - Named parameters
     ...
     * @protected
     */
    protected getMyApps(opts?: any): any[];
    /**
     *
     * @param {object} [opts] - Named parameters
     * @returns { object[] } Success
     * @protected
     */
    protected getReviewApps(opts?: any): any[];
    /**
     *
     * @param {object} [opts] - Named parameters
 ...
 * @param {string} [opts.redirectUrl] - The OAuth2 redirectUrl
 * @param {AthomStorageAdapter} [opts.store] - A persistent store for session data. (defaults to HTML5 LocalStorage if available)
 * @param {boolean} [opts.autoRefreshTokens] - Set to false to disable automatic token refreshing (defaults to true)
 * @param {string} [opts.baseUrl] - A custom baseUrl
 */
declare class AthomCloudAPI {
     ...
     * @protected
     */
    protected getLocationStatistics(opts?: any): any[];
    /**
...
declare module AthomStorageAdapter {
    /**
     * HTML5 LocalStorage Adapter
     * @memberof AthomStorageAdapter
     */
    class LocalStorage {
