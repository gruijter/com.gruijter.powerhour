...
declare namespace AthomCloudAPI {
     ...
     * @property { object } activatedAt Activation Date
     * @hideconstructor
     * @protected
     */
    class Bridge {
...
declare namespace HomeyAPI {
    ...
    class ManagerDatabase {
         ...
         * @protected
         */
        protected optimize(opts?: any): Promise<void>;
    }
    ...
    class ManagerDevkit {
         ...
         * @protected
         */
        protected getUsbMode(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected getAppUsage(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
    ...
    class ManagerFlow {
         ...
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         *  - homey.advancedflow.readonly<br/>
         * </p>
         * @param {object} [opts] - Named parameters
    ...
    class ManagerReminder {
         ...
         * @returns { Promise<void> } Successful response
         */
        getReminders(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
    ...
    class ManagerSpeechInput {
         ...
         * @returns { Promise<void> } Successful response
         */
        getHistory(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @returns { Promise<void> } Successful response
         */
        getSpeechAgents(opts?: any): Promise<void>;
    }
    ...
    class ManagerUpdates {
         ...
         * @protected
         */
        protected getWhatsNew(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected installUpdate(opts?: any): Promise<void>;
        /**
         * Gets this manager's state
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected getState(opts?: any): Promise<object>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected getOptionChannel(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected getOptionAutoupdate(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected getOptionForceChannel(opts?: any): Promise<void>;
        /**
         *
         * <p>
         * <b>Required OAuth scopes:</b><br/>
         ...
         * @protected
         */
        protected getOptionUpdateNotifications(opts?: any): Promise<void>;
        /**
         * Unsubscribes to realtime events, clear all caches, and remove all event listeners for this manager and it's managed objects
         */
        destroy(): void;
...
declare class AthomAppsAPI {
     ...
     * @protected
     */
    protected syncApps(opts?: any): Promise<object[]>;
    /**
     *
     * @param {object} [opts] - Named parameters
     ...
     * @protected
     */
    protected getHighlightedApps(opts?: {
        platforms?: string;
    }): Promise<object>;
    /**
     *
     ...
     * @protected
     */
    protected getMyApps(opts?: any): Promise<object[]>;
    /**
     *
     * @param {object} [opts] - Named parameters
     * @returns { Promise<object[]> } Success
     * @protected
     */
    protected getReviewApps(opts?: any): Promise<object[]>;
    /**
     *
     * @param {object} [opts] - Named parameters
     ...
     * @protected
     */
    protected getAppInstallStats(opts?: {
        appId: string;
    }): Promise<object[]>;
    /**
     *
     ...
     * @protected
     */
    protected getCrashesStats(opts?: {
        appId: string;
        buildId: string;
    }): Promise<object[]>;
    /**
     ...
     * @protected
     */
    protected getReviewsStats(opts?: {
        appId: string;
    }): Promise<object[]>;
    /**
     *
...
declare class AthomCloudAPI {
     ...
     * @protected
     */
    protected getDelegationTokenKey(opts?: any): Promise<string>;
    /**
     ...
     * @protected
     */
    protected updateUserDevice(opts?: {
        userId: string;
        deviceId: string;
        device: AthomCloudAPI.UserDevice;
    }): Promise<AthomCloudAPI.UserDevice>;
     ...
     * @protected
     */
    protected deleteUserDevice(opts?: {
        userId: string;
        deviceId: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected getUserAddresses(opts?: {
        userId: string;
     ...
     * @protected
     */
    protected deleteUserAddress(opts?: {
        userId: string;
        addressId: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected addRoleAppDeveloperTrusted(opts?: {
        userId: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected removeRoleAppDeveloperTrusted(opts?: {
        userId: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected getUserSessions(opts?: {
        userId: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected deleteUserSession(opts?: {
        userId: string;
        sessionId: string;
    }): Promise<void>;
    /**
     ...
     * @protected
     */
    protected subscribeUserToMailChimp(opts?: {
        listId: string;
        userId: string;
    }): Promise<void>;
    /**
     ...
     * </p>
     * @param {object} [opts] - Named parameters
     * @returns { Promise<object[]> } Apps grouped by version
     * @protected
     */
    protected getAppInstallsStatistics(opts?: any): Promise<object[]>;
    /**
     *
     * <p>
     * <b>Required OAuth scopes:</b><br/>
     ...
     * @protected
     */
    protected getLocationStatistics(opts?: any): Promise<object[]>;
    /**
     ...
     * @protected
     */
    protected getVersionStatistics(opts?: any): Promise<{
        [key: string]: number;
    }>;
    /**
     * Obtain a list of Homeys
...
declare class AthomSetupAPI {
     ...
     * @protected
     */
    protected createSession(opts?: any): Promise<object>;
    /**
     * Get a session.
     * @param {object} [opts] - Named parameters
     * @param { string } opts.sessionId
     ...
     * @protected
     */
    protected getTimezone(opts?: any): Promise<object>;
}
...
declare class AthomSignalsAPI {
     ...
     * @returns { Promise<AthomSignalsAPI.StrippedSignal[]> } Success
     * @protected
     */
...
declare class AthomStoreAPI {
     ...
     * @protected
     */
    protected getProducts(opts?: any): Promise<object>;
    /**
     * Get a store product
     * @param {object} [opts] - Named parameters
     ...
     * @protected
     */
    protected getCart(opts?: any): Promise<object>;
    /**
     ...
     * @protected
     */
    protected getLocales(opts?: any): Promise<object>;
    /**
     * Set locale
     * @param {object} [opts] - Named parameters
     ...
     * @protected
     */
    protected createOrder(opts?: any): Promise<object>;
    /**
     * Pay an order
     * @param {object} [opts] - Named parameters
     ...
     * @protected
     */
    protected deleteSession(opts?: any): Promise<object>;
    /**
     * Get your orders
     * @param {object} [opts] - Named parameters
     * @returns { Promise<object> } Success
     * @protected
     */
    protected getOrders(opts?: any): Promise<object>;
    /**
     * Get an order
     * @param {object} [opts] - Named parameters
     * @param { string } opts.orderId
     ...
     * @protected
     */
    protected logout(opts?: any): Promise<object>;
    /**
     ...
     * @protected
     */
    protected getExpiredSubscriptions(opts?: {
        users: string[];
        secret: string;
    }): Promise<object>;
}
