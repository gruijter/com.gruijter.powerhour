...
const ECB = require('../lib/providers/ECB');
const FORECAST = require('../lib/providers/Stekker');
...
class MyDevice extends Homey.Device {
  ...
  async setState() {
    ...
    let statsNextDay = { min: null, max: null, avg: null, minIndex: null, maxIndex: null };
