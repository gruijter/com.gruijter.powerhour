...
class BatDriver extends Driver {
  ...
  async pollEnergyLogic(interval) {
    ...
    let strategy = this.calculateStrategy(batteryInfo, totalTarget, totalBattSoc, totalEmptySpace, minLoad);
  ...
  calculateStrategy(batteryInfo, totalTarget, totalBattSoc, totalEmptySpace, minLoad) {
