  ...
  async fetchPrices() {
    try {
      ...
      if (this.marketPrices && this.marketPrices.length > 0) {
        ...
        // Skip fetching if we have today's prices and it is before 12:00 Brussels time (ENTSO-E publication time)
        ...
        if (this.driver.id !== 'dapg' && hasToday && nowBrussels.getHours() < 12) {
