...
const getGridForecastChart = async (weeklyProfile, startTm, endTm, title, realPowerData = [], timezone = 'UTC') => {
  ...
  while (current < end) {
    ...
    realPower = entry && typeof entry.power === 'number' ? entry.power : null;
