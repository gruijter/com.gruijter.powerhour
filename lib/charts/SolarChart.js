...
const getSolarChart = async (forecastData, yieldFactors, startTm, endTm, title, realPowerData = [], timezone = 'UTC', absoluteMaxPower = 0) => {
  ...
  const yMax = absoluteMaxPower > 0 ? Math.round((absoluteMaxPower * 1.1) / 100) * 100 : maxVal * 1.2;
