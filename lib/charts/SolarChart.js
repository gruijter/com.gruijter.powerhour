...
const getSolarChart = async (forecastData, yieldFactors, startTm, endTm, title, realPowerData = [], timezone = 'UTC', globalMaxYF = 0) => {
  ...
  let maxVal = globalMaxYF ? globalMaxYF * 1000 : 0;
      ...
      scales: {
        ...
        yAxes: [{
          ticks: {
            ...
            fontColor: 'white',
            beginAtZero: true,
            suggestedMax: maxVal * 1.2, // Add 20% headroom based on PV peak
          },
          gridLines: {
            color: 'rgba(255,255,255,0.2)',
          },
