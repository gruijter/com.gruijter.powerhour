...
class EnergyPollingHelper {
  ...
  async startPolling() {
    ...
    if (typeof api.energy?.getLiveReport !== 'function') {
      this.logger.log('Homey Energy getLiveReport API is not available on this Homey model. Centralized energy polling disabled.');
      this.isPolling = false;
      return;
    }
