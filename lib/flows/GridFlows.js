...
class GridFlows extends SumFlows {
  ...
  async load_json(args) {
    ...
    // getLocalTimeDetails uses real UTC timestamps and converts via toLocaleString — correct for all timezones
    ...
    return { load: JSON.stringify(values), accuracy: JSON.stringify(accuracy) };
  }
