...
// EntsoeGruijter, plus IT_Italy_North and HU_Hungary against api.energy-charts.info, which were
// used because EntsoeGruijter carries neither zone. Re-verify with the same method before adding
// an id; a wrong mapping here silently serves another country's prices.
const filterMap = {
  '10YDK-1--------W': 252, // DK1
  '10YDK-2--------M': 253, // DK2
  '10YFR-RTE------C': 254, // FR
