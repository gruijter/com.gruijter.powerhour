...
const processHistoricData = ({
  ...
  if (globalNightValues.length > 0) {
    ...
    logger(`[processHistoricData] NightFloor Analysis | min=${globalNightValues[0]}W, p1=${globalNightValues[p1Index]}W, p5=${globalNightValues[p5Index]}W, p10=${globalNightValues[p10Index]}W, median=${globalNightValues[p50Index]}W`);
