...
class MeterHelpers {
   ...
   */
  static getPeriodTariff(tariffHistory, priceInterval, currentTm, lastTm) {
    let tariff = tariffHistory.current;
    let exportTariff = typeof tariffHistory.currentExport === 'number' ? tariffHistory.currentExport : tariff;
