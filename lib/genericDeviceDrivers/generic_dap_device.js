...
class MyDevice extends Homey.Device {
  ...
  async onHourlyEvent() {
    ...
    await setTimeoutPromise(this.fetchDelay, this); // spread over 5 minutes for API rate limit
    if (this.isDestroyed) return;
    await this.fetchPrices();
  }
  ...
  async setCapabilitiesAndFlows(options) {
    try {
      ...
      const dayChanged = oldState.dayNumber !== undefined && this.state.dayNumber !== oldState.dayNumber;
