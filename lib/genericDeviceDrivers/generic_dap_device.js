    ...
    try {
      ...
      if (!options || !options.noTriggers) {
        ...
        if (Number.isFinite(this.state.priceNow)) {
          ...
          if (app && app.trigger_price_highest_next_hours) app.trigger_price_highest_next_hours(this, tokens, state);
          if (app && app.trigger_price_lowest_next_hours) app.trigger_price_lowest_next_hours(this, tokens, state);
          if (app && app.trigger_price_lowest_next_known_hours) app.trigger_price_lowest_next_known_hours(this, tokens, state);
          if (app && app.trigger_price_highest_next_known_hours) app.trigger_price_highest_next_known_hours(this, tokens, state);
        }
      }
    } catch (error) {
      this.error(error);
