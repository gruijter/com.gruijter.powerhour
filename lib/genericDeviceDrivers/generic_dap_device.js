...
class MyDevice extends Homey.Device {
  ...
  async fetchPrices() {
    try {
      ...
      const primaryProviderName = this.dap && this.dap[0] ? this.dap[0].constructor.name : null;
      ...
      const newMarketPrices = await PriceFetchStrategy.fetchPrices(this.dap, periods, resolution, validator, logger, skipCheck.primaryOnly);
